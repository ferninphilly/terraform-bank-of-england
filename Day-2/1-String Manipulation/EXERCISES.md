# Terraform Functions Learning Guide - Challenge Exercises

This file contains challenge-based exercises for Terraform string manipulation and functions. You'll need to figure out the implementation yourself!

**👉 For step-by-step instructions, see [README.md](./README.md)**

## 📋 Learning Options

- **Step-by-Step Tutorial:** See [README.md](./README.md) for detailed walkthrough
- **Challenge Exercises:** This file (EXERCISES.md) - figure it out yourself!
